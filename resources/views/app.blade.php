...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta inertia head-key="description" name="description" content="Bronx Batteries — reliable alkaline batteries. Power you can depend on.">
        <meta inertia head-key="og:title" property="og:title" content="Bronx Batteries">
        <meta inertia head-key="og:description" property="og:description" content="Bronx Batteries — reliable alkaline batteries. Power you can depend on.">
